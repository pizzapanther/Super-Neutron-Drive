    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verified_email', models.EmailField(max_length=75, null=True, verbose_name=b'verified email address', blank=True)),
                ('verified', models.BooleanField(default=False)),
                ('newsletter', models.BooleanField(default=False, verbose_name=b'Subscribe to Newsletter')),
